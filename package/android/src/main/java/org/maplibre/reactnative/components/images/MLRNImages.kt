package com.mapvina.reactnative.components.images
...
import com.mapvina.reactnative.utils.DownloadMapImageTask
import com.mapvina.reactnative.utils.ImageEntry
...
class MLRNImages(
    ...
    override fun addToMap(mapView: MLRNMapView) {
        ...
        mapView.getStyle { _ ->
            val mapInstance = mapView.mapVinaMap
            map = mapInstance
            map?.let {
