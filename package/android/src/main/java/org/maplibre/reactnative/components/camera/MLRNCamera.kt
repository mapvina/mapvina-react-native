...
import com.mapvina.reactnative.location.LocationManager
import com.mapvina.reactnative.location.LocationManager.OnUserLocationChange
import com.mapvina.reactnative.location.TrackUserLocationMode
import com.mapvina.reactnative.location.TrackUserLocationState
import com.mapvina.reactnative.location.UserLocation
...
class MLRNCamera(
    ...
    private fun updateUserLocationSignificantly() {
        ...
        val cameraUpdate =
            newCameraPosition(getUserLocationUpdateCameraPosition(mapView!!.mapVinaMap!!.cameraPosition.zoom))
    ...
    private fun enableLocation() {
        ...
        mapView!!.mapVinaMap!!.getStyle { style ->
    ...
    fun setTrackUserLocation(trackUserLocationMode: Int) {
        ...
        if (mapvinaMap != null) {
            updateLocationLayer(mapvinaMap!!.style!!)
        }
    }
