...
- (void)setCenter:(CGPoint)center {
  ...
  if (_map != nil) {
    ...
    // Reject map-redraw resets: MapVina re-projects annotations from their
...
- (MLNAnnotationView *)getAnnotationView {
  ...
  if (!hasCustomChildren) {
    ...
    NSBundle *mapVinaBundle = [NSBundle bundleForClass:[MLNMapView class]];
    UIImage *pinImage = [UIImage imageNamed:@"default_marker"
                                   inBundle:mapVinaBundle
